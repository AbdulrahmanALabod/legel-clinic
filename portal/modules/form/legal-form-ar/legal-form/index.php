...
<body>
    <!-- welcom page-->
                        ...
                        <div class="form-check form-switch" style="display: none;">
                            <div class="switch-lan">
                                ...
                                <div class="switch-language">
                                    <input name="radio" type="radio" value="optionar" id="optionar" checked>
                                    <label for="optionar">AR</label>
                                    <input name="radio" type="radio" value="optionen" id="optionen" onclick="location.href = '../../index.php';">
                                    <label for="optionen" class="right">EN</label>
        ...
        <section >
         <form action="./payment/CashierCreateController.php" id="form" method="POST" class="needs-validation" enctype = "multipart/form-data" novalidate>
                            ...
                            <div  id="choice-Money">
                                ...
                                <div class="choice d-flex justify-content-center flex-column align-items-end">
                                    <div class="form-check d-flex flex-row-reverse mt-3">
                                        <div>
                                            <input class="form-check-input radioComp" type="radio"  name="company_type"  id="exampleRadios1" value="LimitedLiabilityCompany" onclick="checkboxSelection()"  required></div>
                                        <div class="mr-3">
                        ...
                        <div class="layer">
                            <div class="d-flex justify-content-center align-items-center" style="height:20vh">
                                <div class="down-paper text-center">
                                    <button  onclick = "download_docx('incorporation-poa-amended.docx');" type  ="button"class="btn btn-down-paper">
                                    <img src="images/Vector (1).svg" > تحميل التوكيل وملا البيانات</button>
                                </div>
                            </div>
                            ...
                            <div class="container">
                               <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4 justify-content-center">
                                    <div class="col">
                                        ...
                                        <div class="card h-100">
                                            ...
                                            <ul class="row row-cols-xxl-2 row-cols-xl-1 row-cols-lg-2 row-cols-1 gx-4 justify-content-center">
                                                ...
                                                <li class="col">
                                                <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.80296 1.13629L6.86296 0.196289L3.99962 3.05962L1.13629 0.196289L0.196289 1.13629L3.05962 3.99962L0.196289 6.86296L1.13629 7.80296L3.99962 4.93962L6.86296 7.80296L7.80296 6.86296L4.93962 3.99962L7.80296 1.13629Z" fill="#FB0F0F"></path>
                                                </svg>
                                    ...
                                    <div class="col">
                                        <label for="radio_2">
                                        <input type="radio"      class="card-input-element hidden" id="radio_2" name="radio" checked  />

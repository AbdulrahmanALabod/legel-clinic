...
<body class="web-to-lead <?php echo $form->form_key; ?>"<?php if (is_rtl(true)) {echo ' dir="rtl"';}?>>
  <div class="container-fluid">
    <div class="row">
      <div class="<?php if ($this->input->get('col')) {echo $this->input->get('col');} else {echo 'col-md-12';}?>">
        ...
        <?php echo form_hidden('key', $form->form_key); ?>
            ...
            <fieldset <?php echo ($i > 1) ? "disabled" : ""; ?>>
              <div class="row">
                <div class="col-md-12 text-right">
                  <span class="current_span"><?php echo $i; ?></span><span class="stroke_span">/</span></span><span class="total_span"><?php echo count($form_fields) ?></span>
                </div>
            </div>
          ...
          <fieldset>
            <div class="row">
                <div class="col-md-12 text-right">
                  <span class="current_span"><?php echo count($form_fields) + 1; ?></span><span class="stroke_span">/</span></span><span class="total_span"><?php echo count($form_fields) + 1; ?></span>
                </div>
            </div>
         <div class="col-md-12">
         <?php if (show_recaptcha() && $form->recaptcha == 1) {?>
      ...
      <div class="row">
        <div class="col-md-12">
          <input type="button" data-page="<?php echo $i + 1; ?>" name="previous" class="previous action-button" value="Previous" />
          <button class="primary large action-button next btn btn-success" id="form_submit" type="submit"><?php echo $form->submit_btn_name; ?></button>
        </div>
      </div>
    </fieldset>

                    ...
                    <div class=" social-icons-light mb-0 d-flex">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-start" aria-labelledby="dropdownMenuLink">
                                <li><a class="dropdown-item" href="<?php echo site_url('clients'); ?>"><img src="<?php echo base_url('assets/images/main/dashicon.svg"') ?>" alt="dashicon"><span class="px-2">Home</span></a></li>

...
app_customers_footer();
   ...
   */
   app_js_alerts();
   ?>
     <!--<script src="https://unruffled-hugle.45-76-42-208.plesk.page/js/jquery.js"></script>-->
     <script src="https://unruffled-hugle.45-76-42-208.plesk.page/js/popper.js"></script>
     <!--<script src="https://unruffled-hugle.45-76-42-208.plesk.page/css/bootstrap-5.0.2-dist/js/bootstrap.bundle.min.js"></script>-->
</body>
</html>
